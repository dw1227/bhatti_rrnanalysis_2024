...
### Conclusions ...
* Analysis depends on our comfort with uncertainty (prob = 90% or 95%) and the 
number of rrn copies per genomes.
* Regardless of the number of operons or region, we need a significantly higher
threshold than esvs or even "traditional" ASVs are defined at. Frankly, 3% doesn't
look so bad for this type of analysis.

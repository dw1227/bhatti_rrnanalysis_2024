...
```
* Even if we require that every taxonomic group has at least 5 genomes, there would
be a a few hundred species represented.
* Not sure I trust the strain level data as being complete. There may be taxa in 
the strain rank that are in the species but the people that deposited the data
